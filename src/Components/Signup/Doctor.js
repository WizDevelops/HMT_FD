        ...
        <div className='doc-text'>
            ...
            <div className='doc-form'>
                ...
                <form action="post" >    
                    ...
                    <div style={{display: 'flex'}}>
                    <select id="dropdown" style={{marginRight: '10px'}}>
                            <option value="Gender" >Qualification</option>
                            <option value="option1">MBBS</option>
                            <option value="option2">MD</option>
                            <option value="option3">Other</option>
                        </select>
                        <select id="dropdown" style={{marginLeft: '10px'}}>
                            <option value="Gender" >Specialization</option>
                            <option value="option1">Orthopedics</option>
                            <option value="option2">Radiology</option>
                            <option value="option3">Dermatology</option>
                        </select>
                    </div>
                    <input type="text" id="address" name="address" placeholder='Hospital Affiliation*' required/><br />
                    <input type="text" id="address" name="address" placeholder='License Number*' required/><br />
                    <div>
